...
from app.schemas.product import ProductListGet
...
async def add_product(
    ...
    await create_product(name, descriotion, price, category_id, urls["photo1"], session)
...
async def get_products_magazine(
